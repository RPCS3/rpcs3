...
sudo wget -qO /etc/apt/sources.list.d/lunarg-vulkan-1.4.341-$UBUNTU_CODENAME.list https://packages.lunarg.com/vulkan/1.4.341/lunarg-vulkan-1.4.341-$UBUNTU_CODENAME.list
sudo apt update
