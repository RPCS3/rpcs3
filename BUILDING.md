...
**Either add the** `QTDIR` **environment variable, e.g.** `<QtInstallFolder>\6.8.0\msvc2022_64\` **, or use the [Visual Studio Qt Plugin](https://marketplace.visualstudio.com/items?itemName=TheQtCompany.QtVisualStudioTools2019)**
