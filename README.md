...
Most files are licensed under the terms of GNU GPLv2 License; see [LICENSE](LICENSE) file for details. Some files may be licensed differently; check appropriate file headers for details.
