...
* [Qt 5.9.3](https://www.qt.io/download-open-source/) (required; add QTDIR `<QtInstallFolder>\5.9.3\msvc2017_64\` environment variable if you do not want to use the Visual Studio Qt Plugin)
...
1) Add `QTDIR` environment variable and set it to `<QtInstallFolder>\5.9.3\msvc2017_64\` </br>
...
1) Go to the Qt5 menu and edit Qt5 options. Add the path to your Qt installation with compiler e.g. `C:\Qt\5.9.3\msvc2017_64`. </br>
