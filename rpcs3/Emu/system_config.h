...
struct cfg_root : cfg::node
{
	...
	public:
		...
		cfg::_bool spu_reservation_busy_waiting_boost_enabled{this, "Enable SPU Reservation Busy Waiting Boost", false, true};
		cfg::_bool ppu_postponed_notification_disabled{ this, "Disable PPU Postponed Notification", false, true };
