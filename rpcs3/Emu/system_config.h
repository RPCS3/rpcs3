...
struct cfg_root : cfg::node
{
	struct node_core : cfg::node
	{
		...
		cfg::_bool ppu_accurate_fma{ this, "Force Accurate FMA", true }; // Enable accurate FMA for CPUs which do not support it natively (can't be disabled for CPUs which do support it)
