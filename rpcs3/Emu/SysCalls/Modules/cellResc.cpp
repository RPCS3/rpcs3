...
void SetupSurfaces(vm::ptr<CellGcmContextData>& cntxt)
{
	...
	r.m_surface_offset[0] = dstOffset0;
	r.m_surface_pitch[0] = s_rescInternalInstance->m_dstPitch;
	//surface.colorLocation[1] = CELL_GCM_LOCATION_LOCAL;
	r.m_surface_offset[1] = (!isMrt) ? 0 : dstOffset1;
	r.m_surface_pitch[1] = (!isMrt) ? 64 : s_rescInternalInstance->m_dstPitch;
	//surface.colorLocation[2] = CELL_GCM_LOCATION_LOCAL;
	r.m_surface_offset[2] = 0;
	r.m_surface_pitch[2] = 64;
	//surface.colorLocation[3] = CELL_GCM_LOCATION_LOCAL;
	r.m_surface_offset[3] = 0;
	r.m_surface_pitch[3] = 64;
