...
enum // old consts
{
	...
	CELL_GAMEDATA_CBRESULT_ERR_NOSPACE = 0xffffffff,
	CELL_GAMEDATA_CBRESULT_ERR_BROKEN = 0xfffffffd,
	CELL_GAMEDATA_CBRESULT_ERR_NODATA = 0xfffffffc,
	CELL_GAMEDATA_CBRESULT_ERR_INVALID = 0xfffffffb,
