...
public:
	...
	void LoadSettings()
	{
		...
		m_pads[0].m_sticks.Move(new AnalogStick(CELL_PAD_BTN_OFFSET_ANALOG_RIGHT_X, WXK_NUMPAD4, WXK_NUMPAD6));
		m_pads[0].m_sticks.Move(new AnalogStick(CELL_PAD_BTN_OFFSET_ANALOG_RIGHT_Y, WXK_NUMPAD8, WXK_NUMPAD2));
	}
};
