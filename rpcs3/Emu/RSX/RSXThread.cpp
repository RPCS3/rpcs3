...
void RSXThread::DoCmd(const u32 fcmd, const u32 cmd, const u32 args_addr, const u32 count)
{
	...
	case NV4097_SET_COLOR_MASK_MRT:
	{
		...
		m_color_mask_mrt1_a = a0 & 0x1000000 ? true : false;
		m_color_mask_mrt1_r = a0 & 0x0010000 ? true : false;
		m_color_mask_mrt1_g = a0 & 0x1000100 ? true : false;
		m_color_mask_mrt1_b = a0 & 0x1000001 ? true : false;
		m_color_mask_mrt2_a = (a0 >> 8) & 0x1000000 ? true : false;
		m_color_mask_mrt2_r = (a0 >> 8) & 0x0010000 ? true : false;
		m_color_mask_mrt2_g = (a0 >> 8) & 0x1000100 ? true : false;
		m_color_mask_mrt2_b = (a0 >> 8) & 0x1000001 ? true : false;
		m_color_mask_mrt3_a = (a0 >> 16) & 0x1000000 ? true : false;
		m_color_mask_mrt3_r = (a0 >> 16) & 0x0010000 ? true : false;
		...
		LOG_WARNING(RSX, "mrt2 r mask: %s", m_color_mask_mrt2_r ? "true" : "false");
		LOG_WARNING(RSX, "mrt2 g mask: %s", m_color_mask_mrt2_g ? "true" : "false");
		LOG_WARNING(RSX, "mrt2 b mask: %s", m_color_mask_mrt2_b ? "true" : "false");
		LOG_WARNING(RSX, "mrt2 a mask: %s", m_color_mask_mrt2_a ? "true" : "false");
