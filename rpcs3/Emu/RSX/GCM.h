...
namespace rsx
{
	...
	template<typename ...T>
	static size_t make_command(vm::ptr<u32>& dst, u32 start_register, T... values)
	{
	...
	static size_t make_jump(vm::ptr<u32>& dst, u32 offset)
	{
		vm::write32(dst.addr(), make_jump(offset));
		dst++;
		return 1;
	}
