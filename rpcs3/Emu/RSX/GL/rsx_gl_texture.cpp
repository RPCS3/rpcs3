...
namespace
{
	...
	std::array<GLenum, 4> get_swizzle_remap(u32 texture_format)
	{
		...
		case CELL_GCM_TEXTURE_G8B8: return { GL_GREEN, GL_RED, GL_GREEN, GL_RED};
		case CELL_GCM_TEXTURE_X16: return { GL_RED, GL_ONE, GL_RED, GL_ONE };
		case CELL_GCM_TEXTURE_Y16_X16: return { GL_RED, GL_GREEN, GL_RED, GL_GREEN};
		...
		case CELL_GCM_TEXTURE_Y16_X16_FLOAT: return { GL_GREEN, GL_RED, GL_GREEN, GL_RED};
		case CELL_GCM_TEXTURE_COMPRESSED_HILO8: return{ GL_RED, GL_GREEN, GL_RED, GL_GREEN };
		case CELL_GCM_TEXTURE_COMPRESSED_HILO_S8: return{ GL_RED, GL_GREEN, GL_RED, GL_GREEN };
		case CELL_GCM_TEXTURE_A1R5G5B5:
		case CELL_GCM_TEXTURE_R5G6B5:
		case CELL_GCM_TEXTURE_A8R8G8B8:
		case CELL_GCM_TEXTURE_R6G5B5:
