...
namespace gl
{
	...
	public:
		...
		buffer_pointer operator + (u32 offset) const
		{
			return{ (vao*)this, offset };
		}

		operator buffer_pointer() const
		{
			return{ (vao*)this };
		}
	};
