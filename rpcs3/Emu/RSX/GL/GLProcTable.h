...
OPENGL_PROC(PFNGLPROGRAMSTRINGARBPROC, ProgramStringARB);
OPENGL_PROC(PFNGLBINDPROGRAMARBPROC, BindProgramARB);
OPENGL_PROC(PFNGLDELETEPROGRAMSARBPROC, DeleteProgramsARB);
OPENGL_PROC(PFNGLGENPROGRAMSARBPROC, GenProgramsARB);
OPENGL_PROC(PFNGLPROGRAMENVPARAMETER4DARBPROC, ProgramEnvParameter4dARB);
OPENGL_PROC(PFNGLPROGRAMENVPARAMETER4DVARBPROC, ProgramEnvParameter4dvARB);
OPENGL_PROC(PFNGLPROGRAMENVPARAMETER4FARBPROC, ProgramEnvParameter4fARB);
OPENGL_PROC(PFNGLPROGRAMENVPARAMETER4FVARBPROC, ProgramEnvParameter4fvARB);
OPENGL_PROC(PFNGLPROGRAMLOCALPARAMETER4DARBPROC, ProgramLocalParameter4dARB);
OPENGL_PROC(PFNGLPROGRAMLOCALPARAMETER4DVARBPROC, ProgramLocalParameter4dvARB);
OPENGL_PROC(PFNGLPROGRAMLOCALPARAMETER4FARBPROC, ProgramLocalParameter4fARB);
OPENGL_PROC(PFNGLPROGRAMLOCALPARAMETER4FVARBPROC, ProgramLocalParameter4fvARB);
OPENGL_PROC(PFNGLGETPROGRAMENVPARAMETERDVARBPROC, GetProgramEnvParameterdvARB);
OPENGL_PROC(PFNGLGETPROGRAMENVPARAMETERFVARBPROC, GetProgramEnvParameterfvARB);
OPENGL_PROC(PFNGLGETPROGRAMLOCALPARAMETERDVARBPROC, GetProgramLocalParameterdvARB);
OPENGL_PROC(PFNGLGETPROGRAMLOCALPARAMETERFVARBPROC, GetProgramLocalParameterfvARB);
OPENGL_PROC(PFNGLGETPROGRAMIVARBPROC, GetProgramivARB);
OPENGL_PROC(PFNGLGETPROGRAMSTRINGARBPROC, GetProgramStringARB);
OPENGL_PROC(PFNGLISPROGRAMARBPROC, IsProgramARB);
