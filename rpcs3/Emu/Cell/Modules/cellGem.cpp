...
static bool mouse_input_to_pad(const u32 mouse_no, be_t<u16>& digital_buttons, be_t<u16>& analog_t)
{
	...
	if (is_pressed(CELL_MOUSE_BUTTON_6) || (is_pressed(CELL_MOUSE_BUTTON_3) && is_pressed(CELL_MOUSE_BUTTON_1)))
		digital_buttons |= CELL_GEM_CTRL_SELECT;

	if (is_pressed(CELL_MOUSE_BUTTON_7) || (is_pressed(CELL_MOUSE_BUTTON_3) && is_pressed(CELL_MOUSE_BUTTON_2)))
		digital_buttons |= CELL_GEM_CTRL_START;

	if (is_pressed(CELL_MOUSE_BUTTON_8) || (is_pressed(CELL_MOUSE_BUTTON_3) && is_pressed(CELL_MOUSE_BUTTON_4)))
		digital_buttons |= CELL_GEM_CTRL_TRIANGLE;

	if (is_pressed(CELL_MOUSE_BUTTON_9) || (is_pressed(CELL_MOUSE_BUTTON_3) && is_pressed(CELL_MOUSE_BUTTON_5)))
		digital_buttons |= CELL_GEM_CTRL_SQUARE;
