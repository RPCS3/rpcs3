...
error_code cellVideoOutGetDeviceInfo(u32 videoOut, u32 deviceIndex, vm::ptr<CellVideoOutDeviceInfo> info)
{
	...
	// A real Full HD display also advertises the lower standard modes in its EDID. Some games (e.g. Metal Gear
	// Solid V: Ground Zeroes) render at 720p and look up that mode in the device info; if it is missing their
	// internal lookup returns a null descriptor and they crash. So, to  avoid any crash, advertise 720p/480p here as hardware does.
	...
	case video_resolution::_1080i:
		...
		add_mode(CELL_VIDEO_OUT_RESOLUTION_720, CELL_VIDEO_OUT_SCAN_MODE_INTERLACE, CELL_VIDEO_OUT_DISPLAY_CONVERSION_NONE, CELL_VIDEO_OUT_ASPECT_16_9);
