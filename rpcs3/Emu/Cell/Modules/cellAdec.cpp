		...
		case LpcmDecCmdType::decode_au:
		{
			...
			else
			{
				...
				case CELL_ADEC_BIT_LENGTH_20:
				{
					...
					static constexpr v128 shuffle_ctrl_same_offset = std::endian::native == std::endian::little
						? v128::normal_array_t<s8>{ -1, 8, 1, 0, -1, 8, 3, 2, -1, 11, 5, 4, -1, 11, 7, 6 }
						: v128::normal_array_t<s8>{ 0, 1, 8, -1, 2, 3, 8, -1, 4, 5, 11, -1, 6, 7, 11, -1 };

					static constexpr v128 shuffle_ctrl_different_offset = std::endian::native == std::endian::little
					...
					static constexpr v128 low_bits_mask_different_offset = std::endian::native == std::endian::little
