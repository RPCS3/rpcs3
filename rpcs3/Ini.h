...
public:
	...
	IniEntry<bool> GSWriteColorBuffers;
	IniEntry<bool> GSWriteDepthBuffer;
...
public:
	Inis() : DefPath("EmuSettings")
	{
		...
		GSWriteColorBuffers.Init("GS_WriteColorBuffers", path);
		GSWriteDepthBuffer.Init("GS_WriteDepthBuffer", path);
		GSReadColorBuffers.Init("GS_GSReadColorBuffers", path);
		GSReadDepthBuffer.Init("GS_GSReadDepthBuffer", path);
	...
	void Load()
	{
		...
		GSWriteColorBuffers.Load(true);
		GSWriteDepthBuffer.Load(false);
	...
	void Save()
	{
		...
		GSFrameLimit.Save();
		GSLogPrograms.Save();
		GSWriteColorBuffers.Save();
		GSWriteDepthBuffer.Save();
