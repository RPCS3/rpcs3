...
MemoryStringSearcher::MemoryStringSearcher(QWidget* parent)
	: QDialog(parent)
{
	...
	connect(button_search, &QAbstractButton::clicked, this, &MemoryStringSearcher::OnSearch);
};

void MemoryStringSearcher::OnSearch()
{
