...
RSXDebugger::RSXDebugger(QWidget* parent) 
	: QDialog(parent)
	, m_item_count(37)
	, m_addr(0x0)
	, m_cur_texture(0)
...
void RSXDebugger::OnClickDrawCalls()
{
...
QString RSXDebugger::DisAsmCommand(u32 cmd, u32 count, u32 currentAddr, u32 ioAddr)
{
	std::string disasm = "";
