...
public:
	...
	const struct gamepad_settings
	{
		...
		const QString direct_input      = tr("The DirectInput handler should work with almost any controller recognized by Windows. However, it is recommended that you use the more specific handlers if you have a controller that supports them.");
