...
public:
	...
	const struct settings
	{
		...
		const QString resolution_scale           = tr("Scales the game's resolution by the given percentage.\nThe base resolution is 1280x720 if the game does not support the selected virtual TV-Resolution.\nSet this value to 100% if you want to use the selected virtual TV-Resolution without scaling.");
