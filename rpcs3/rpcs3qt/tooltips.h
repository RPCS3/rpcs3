...
public:
	...
	const struct settings
	{
		...
		const QString vsync                      = tr("Synchronizes the game's frame rate with your monitor's refresh rate. \nEliminates screen tearing at the cost of increased input lag.");
