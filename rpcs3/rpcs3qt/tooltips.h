...
public:
	...
	const struct settings
	{
		...
		const QString allow_metadata_in_saves      = tr("Allows certain system files, such as macOS resource forks (._*), to be detected by the game when a save is loaded.\nNormally, these files are generated by certain operating systems on specific file systems and can prevent saves from loading.\nYou usually shouldn't enable this, if ever.");
