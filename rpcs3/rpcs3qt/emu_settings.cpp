...
void emu_settings::EnhanceSpinBox(QSpinBox* spinbox, SettingsType type, const QString& prefix, const QString& suffix)
{
	...
	connect(spinbox, QOverload<const QString &>::of(&QSpinBox::textChanged), [=](const QString&/* text*/)
#else
...
#if QT_VERSION >= QT_VERSION_CHECK(5,14,0)
	connect(spinbox, QOverload<const QString &>::of(&QDoubleSpinBox::textChanged), [=](const QString&/* text*/)
#else
