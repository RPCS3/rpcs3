...
{
	using syscall_function_handler = void(*)(rsx::ppu::thread& ppu);

	void null_func(rsx::ppu::thread& ppu)
	{
	...
	const syscall_function_handler g_sc_table[1024] =
	{
		//null_func,
	...
	void execute_by_index(rsx::ppu::thread& ppu, u64 code)
	{
		if (code >= 1024)
		{
